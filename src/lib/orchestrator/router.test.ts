...
describe("router v10: drafts, redirects and choices (R22, R23, R25)", () => {
  ...
  it("is version 10, asks when in doubt, and teaches drafting, redirecting and choices", () => {
    expect(ROUTER_VERSION).toBe("router-v10");
