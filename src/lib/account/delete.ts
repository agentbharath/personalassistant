...
export async function deleteAccount(userId: string) {
  ...
  for (const table of ["approvals", "workflow_checkpoints", "message_feedback", "email_drafts", "reply_dismissals", "conversation_messages", "conversations"]) await remove(table, userId);
